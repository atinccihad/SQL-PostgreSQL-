...
-- kişiler tablosunu adrese göre tersten sıralayarak sorgulayınız
select * from kisiler order by adres desc --(Desc tersten sıralama yapılacağı zaman yazılır)

-- kişiler maaşı büyükten küçüğe sıralayanız
